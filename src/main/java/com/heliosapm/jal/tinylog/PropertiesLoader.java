...
import com.heliosapm.jal.tinylog.labelers.Labeler;
import com.heliosapm.jal.tinylog.policies.Policy;
import com.heliosapm.jal.tinylog.writers.Writer;

/**
 * Loads configuration for {@link com.heliosapm.jal.tinylog.Logger Logger} from properties.
 */
final class PropertiesLoader {
	...
	private static Writer readWriter(final Properties properties, final String propertyName, final String writerName) {
		for (Class<?> implementation : findImplementations(Writer.class)) {
			com.heliosapm.jal.tinylog.writers.PropertiesSupport propertiesSupport = implementation.getAnnotation(com.heliosapm.jal.tinylog.writers.PropertiesSupport.class);
	...
	private static Writer loadWriter(final Properties properties, final String propertiesPrefix, final com.heliosapm.jal.tinylog.writers.Property[] definition,
	...
	private static Object[] loadParameters(final Properties properties, final String propertiesPrefix, final com.heliosapm.jal.tinylog.writers.Property[] definition) {
	...
	private static Labeler parseLabeler(final String string) {
		...
		for (Class<?> implementation : findImplementations(Labeler.class)) {
			com.heliosapm.jal.tinylog.labelers.PropertiesSupport propertiesSupport = implementation.getAnnotation(com.heliosapm.jal.tinylog.labelers.PropertiesSupport.class);
			if (propertiesSupport != null) {
	...
	private static Policy parsePolicy(final String string) {
		...
		for (Class<?> implementation : findImplementations(Policy.class)) {
			com.heliosapm.jal.tinylog.policies.PropertiesSupport propertiesSupport = implementation.getAnnotation(com.heliosapm.jal.tinylog.policies.PropertiesSupport.class);
			if (propertiesSupport != null) {
				if (name.equalsIgnoreCase(propertiesSupport.name())) {
