...
/**
 * A labeler names log files and backups for {@link com.heliosapm.jal.tinylog.writers.RollingFileWriter RollingFileWriter}.
 *
 * <p>
 * The annotation {@link com.heliosapm.jal.tinylog.labelers.PropertiesSupport PropertiesSupport} must be added to the implemented
 * labeler class and the implemented labeler must be registered as service in
 * "META-INF/services/com.heliosapm.jal.tinylog.labelers" in order to make the labeler available by properties files and system
 * properties.
 * </p>
 *
 * <p>
