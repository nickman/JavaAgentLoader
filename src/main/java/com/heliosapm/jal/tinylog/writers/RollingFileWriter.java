...
import com.heliosapm.jal.tinylog.labelers.CountLabeler;
import com.heliosapm.jal.tinylog.labelers.Labeler;
import com.heliosapm.jal.tinylog.policies.Policy;
import com.heliosapm.jal.tinylog.policies.StartupPolicy;

/**
 * Writes log entries to a file like {@link com.heliosapm.jal.tinylog.writers.FileWriter FileWriter} but keeps backups of old
 * logging files.
 */
...
public final class RollingFileWriter implements Writer {
	 ...
	 *            Number of backups
	 *
	 * @see com.heliosapm.jal.tinylog.policies.StartupPolicy
	 */
